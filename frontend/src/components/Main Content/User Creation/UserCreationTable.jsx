...
export default function UserCreationTable({ handleMenuClick }) {
    ...
    const confirmDeletion = async () => {
      try {
        const response = await fetch(
          `http://localhost:8000/api/users/${clientToDelete._id}`,
          { method: "DELETE" }
        );
        if (response.ok) {
                                  ...
                                  <td>
                                    ...
                                    >
                                      ...
                                      <div className="edit">
                                        ...
                                        <Link
                                          to={`/user-update-form/${client._id}`}
                                          onClick={() =>
                                            handleMenuClick("Update User")
                                          }
